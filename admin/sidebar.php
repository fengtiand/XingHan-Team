...
<nav id="sidebar" aria-label="Main Navigation">
    <div class="content-header">
        ...
        <div>
            <button type="button" class="btn btn-sm btn-alt-secondary" data-toggle="class-toggle" data-target="#page-container" data-class="dark-mode" onclick="toggleTheme();">
    ...
    <div class="js-sidebar-scroll">
        <div class="content-side">
            <ul class="nav-main">
                <li class="nav-main-item">
                    <a class="nav-main-link<?php echo ($current_page === 'index') ? ' active' : ''; ?>" href="index.php">
                        <i class="nav-main-link-icon fa fa-house-user"></i>
                        <span class="nav-main-link-name">首页</span>
                    </a>
                </li>
                <li class="nav-main-item">
                    <a class="nav-main-link<?php echo ($current_page === 'site') ? ' active' : ''; ?>" href="site.php">
                        <i class="nav-main-link-icon fa fa-cog"></i>
                        <span class="nav-main-link-name">网站设置</span>
                    </a>
                </li>
                <li class="nav-main-item">
                    <a class="nav-main-link<?php echo ($current_page == 'home') ? ' active' : ''; ?>" href="home.php">
                        <i class="nav-main-link-icon fa fa-home"></i>
                        <span class="nav-main-link-name">首页内容管理</span>
                    </a>
                </li>
                <li class="nav-main-item">
                    <a class="nav-main-link<?php echo ($current_page == 'team') ? ' active' : ''; ?>" href="team.php">
                        <i class="nav-main-link-icon fa fa-users"></i>
                        <span class="nav-main-link-name">团队成员管理</span>
                    </a>
                </li>
                <li class="nav-main-item">
                    <a class="nav-main-link<?php echo ($current_page == 'manage') ? ' active' : ''; ?>" href="manage.php">
                        <i class="nav-main-link-icon fa fa-briefcase"></i>
                        <span class="nav-main-link-name">网站展示管理</span>
                    </a>
                </li>
                <li class="nav-main-item">
                    <a class="nav-main-link<?php echo ($current_page == 'join') ? ' active' : ''; ?>" href="join.php">
                        <i class="nav-main-link-icon fa fa-user-plus"></i>
                        <span class="nav-main-link-name">加入申请</span>
                    </a>
                </li>
                <li class="nav-main-item">
                    <a class="nav-main-link<?php echo ($current_page == 'mailset') ? ' active' : ''; ?>" href="mailset.php">
                        <i class="nav-main-link-icon fa fa-envelope"></i>
                        <span class="nav-main-link-name">邮箱设置</span>
                    </a>
                </li>
                <li class="nav-main-item">
                        <a class="nav-main-link<?php echo $current_page === 'about' ? ' active' : ''; ?>" href="about.php">
                        <i class="nav-main-link-icon fa fa-info-circle"></i>
                        <span class="nav-main-link-name">关于程序</span>
                    </a>
                </li>
            </ul>
        ...
        <div class="content-side content-side-bottom">
            <ul class="nav-main">
                <li class="nav-main-item">
                    <a class="nav-main-link<?php echo ($current_page === 'passwd') ? ' active' : ''; ?>" href="passwd.php">
