...
<body>
    <div class="container">
        <h1 class="text-center">XingHan-Team（V1.5.0）程序安装</h1>
        <?php if ($step == 1): ?>
            <div class="card mb-4">
                <div class="card-body">
                    <h2 class="card-title">欢迎使用一键安装程序</h2>
                    <p class="card-text">
                    XingHan-Team（V1.5.0）官网程序系统具有以下特点：
                    </p>
                    <ul>
                        <li>响应式设计，适配各种类型</li>
                        <li>团队成员管理功能</li>
            ...
            <table class="table table-striped">
                <tr>
                    ...
                    <td><?php echo version_compare(PHP_VERSION, '7.0.0', '>=') ? '<span class="text-success">通过</span>' : '<span class="text-danger">需要 PHP 7.0.0 或更高版本</span>'; ?></td>
                </tr>
                <tr>
                    <td>MySQL 扩展</td>
        ...
        <?php elseif ($step == 3): ?>
            ...
            <div class="alert alert-info">
                <p>安装已完成，请注意以下事项：</p>
                <ul>
                    <li>后台管理地址：<strong><?php echo 'http://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/../admin/login.php'; ?></strong></li>
